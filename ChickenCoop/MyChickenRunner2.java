...
public class MyChickenRunner2
{
    public static void main(String[] args)
    {
        ...
        world.add(new Location(10, 9),new Chicken());
        world.add(new Location(5,24),new Chicken()); 
        world.add(new Location(14, 21),new Chicken());
        world.add(new Location(6, 17),new Chicken());
        world.add(new Location(7, 20),new Chicken());
        
        world.add(new Location(2,2),new Fox());
        world.add(new Location(19, 3), new Fox());
